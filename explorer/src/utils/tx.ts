...
export enum PROGRAM_NAMES {
  ...
  SWAP = "Swap Program",
  TOKEN = "Token Program",
  TOKEN2022 = "Token Program (2022)",
  TOKEN_METADATA = "Token Metadata Program",
  TOKEN_VAULT = "Token Vault Program",
  MATH = "Math Program",
  RECORD = "Record Program",
  SHARED_MEMORY = "Shared Memory Program",
  STATELESS = "Stateless Program",

  // other
  BINARY_OPTION = "Binary Option Program",
  FAIR_LAUNCH = "Fair Launch Program",
  BINARY_ORACLE = "Binary Oracle Pair",
  GOVERNANCE = "Governance Program",
  GOVERNANCE_CHAT = "Governance Chat Program",
  ...
  NFT_AUCTION_HOUSE = "NFT Auction House Program",
...
export const PROGRAM_DEPLOYMENTS = {
  ...
  [PROGRAM_NAMES.TOKEN2022]: ALL_CLUSTERS,
  [PROGRAM_NAMES.TOKEN_METADATA]: LIVE_CLUSTERS,
  [PROGRAM_NAMES.TOKEN_VAULT]: LIVE_CLUSTERS,
  [PROGRAM_NAMES.MATH]: ALL_CLUSTERS,
  [PROGRAM_NAMES.RECORD]: ALL_CLUSTERS,
  [PROGRAM_NAMES.SHARED_MEMORY]: ALL_CLUSTERS,
  [PROGRAM_NAMES.STATELESS]: ALL_CLUSTERS,

  // other
  [PROGRAM_NAMES.BINARY_OPTION]: ALL_CLUSTERS,
  [PROGRAM_NAMES.FAIR_LAUNCH]: ALL_CLUSTERS,
  [PROGRAM_NAMES.BINARY_ORACLE]: ALL_CLUSTERS,
  [PROGRAM_NAMES.GOVERNANCE]: ALL_CLUSTERS,
  [PROGRAM_NAMES.GOVERNANCE_CHAT]: ALL_CLUSTERS,
  ...
  [PROGRAM_NAMES.NFT_AUCTION_HOUSE]: LIVE_CLUSTERS,
...
export const PROGRAM_NAME_BY_ID = {
  ...
  TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb: PROGRAM_NAMES.TOKEN2022,
  ...
  Math111111111111111111111111111111111111111: PROGRAM_NAMES.MATH,
  ReciQBw6sQKH9TVVJQDnbnJ5W7FP539tPHjZhRF4E9r: PROGRAM_NAMES.RECORD,
  shmem4EWT2sPdVGvTZCzXXRAURL9G5vpPxNwSeKhHUL: PROGRAM_NAMES.SHARED_MEMORY,
  StateLessAsks111111111111111111111111111111: PROGRAM_NAMES.STATELESS,

  // other
  betw959P4WToez4DkuXwNsJszqbpe3HuY56AcG5yevx: PROGRAM_NAMES.BINARY_OPTION,
  faircnAB9k59Y4TXmLabBULeuTLgV7TkGMGNkjnA15j: PROGRAM_NAMES.FAIR_LAUNCH,
  Fd7btgySsrjuo25CJCj7oE7VPMyezDhnx7pZkj2v69Nk: PROGRAM_NAMES.BINARY_ORACLE,
  GovER5Lthms3bLBqWub97yVrMmEogzX7xNjdXpPPCVZw: PROGRAM_NAMES.GOVERNANCE,
  GovernanceChat11111111111111111111111111111: PROGRAM_NAMES.GOVERNANCE_CHAT,
  ...
  hausS13jsjafwWwGqZTUQRmWyvyxn9EQpqMwV1PBBmk: PROGRAM_NAMES.NFT_AUCTION_HOUSE,
