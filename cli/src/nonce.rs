    ...
    fn nonce_subcommands(self) -> Self {
            ...
            SubCommand::with_name("create-nonce-account")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .help("The amount to load the nonce account with, in KUNCI; accepts keyword ALL"),
                )
                .arg(
        ...
        .subcommand(
            SubCommand::with_name("withdraw-from-nonce-account")
                .about("Withdraw KUNCI from the nonce account")
                .arg(
                    pubkey!(Arg::with_name("nonce_account_pubkey")
                        .index(1)
                        .value_name("NONCE_ACCOUNT_ADDRESS")
                ...
                .arg(
                    pubkey!(Arg::with_name("destination_account_pubkey")
                        ...
                        .required(true),
                        "The account to which the KUNCI should be transferred. "),
                )
                .arg(
                    Arg::with_name("amount")
                        .index(3)
                        ...
                        .required(true)
                        .validator(is_amount)
                        .help("The amount to withdraw from the nonce account, in KUNCI"),
                )
                .arg(nonce_authority_arg())
                .arg(memo_arg()),
        )
