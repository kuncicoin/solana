    ...
    fn stake_subcommands(self) -> Self {
            ...
            SubCommand::with_name("create-stake-account")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .required(true)
                        .help("The amount to send to the stake account, in KUNCI; accepts keyword ALL")
                )
                .arg(
            ...
            SubCommand::with_name("split-stake")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount)
                        .required(true)
                        .help("The amount to move into the new stake account, in KUNCI")
                )
                .arg(
                    Arg::with_name("seed")
                        .long("seed")
        ...
        .subcommand(
            SubCommand::with_name("withdraw-stake")
                .about("Withdraw the unstaked KUNCI from the stake account")
                .arg(
                    pubkey!(Arg::with_name("stake_account_pubkey")
                        .index(1)
                        .value_name("STAKE_ACCOUNT_ADDRESS")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount_or_all)
                        .required(true)
                        .help("The amount to withdraw from the stake account, in KUNCI; accepts keyword ALL")
                )
                .arg(
                    Arg::with_name("seed")
                        .long("seed")
