...
impl ClusterQuerySubCommands for App<'_, '_> {
    fn cluster_query_subcommands(self) -> Self {
        ...
        .subcommand(
            SubCommand::with_name("supply").about("Get information about the cluster supply of KUNCI")
            .arg(
        ...
        .subcommand(
            SubCommand::with_name("total-supply").about("Get total number of KUNCI")
            ...
            SubCommand::with_name("rent")
                ...
                .arg(
                    Arg::with_name("lamports")
                        .long("lamports")
                        .takes_value(false)
                        .help("Display rent in lamports instead of KUNCI"),
                ),
        )
    }
}
...
pub fn process_total_supply(rpc_client: &RpcClient, _config: &CliConfig) -> ProcessResult {
    ...
    Ok(format!("{} KUNCI", lamports_to_sol(supply.total)))
}
